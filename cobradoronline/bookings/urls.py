...
from cobradoronline.bookings.views import bookings_list, scheduling, scheduling_edit, bookings_create, bookings_update

app_name = 'bookings'

urlpatterns = [
    url(r'listagem/$', bookings_list, name='bookings_list'),
